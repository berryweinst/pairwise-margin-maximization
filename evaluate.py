...
def main_worker(args):
    ...
    if args.calibrate_bn:
        train_data = DataRegime(None, defaults={'datasets_path': args.datasets_dir, 'name': args.dataset, 'split': 'train', 'augment': False,
...
#./results/resnet28_wide_cifar100_wt2_rmax_sqr_alpha_1e_5_1e_3_meas_w_x
#/home/bweinstein/mms-select/results/resnet28_wide_cifar100_baseline_radius_div_mms_sqr